...
const CreatBlogPost: React.FC<Props> = (props) => {
    ...
    const renderHeading = () => {
        return (
            <div className={`text-4xl ${theme.textFirst} flex justify-center m-10`}>
                Create Blog Post
            </div>
        )
    }
    ...
    return (
        <div className="w-9/12 flex flex-col m-auto">
            ...
            <div className="flex justify-center">
                <button className={`${theme.bgFirst} ${theme.textFifth} w-1/2 p-2 m-4 rounded-md shadow-xl`} onClick={createBlogPost}>Create Post</button>
            </div>
        </div>
    )
